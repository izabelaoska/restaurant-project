    ...
    <>
      <div className="min-h-[450px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 h-full">
        <div className="h-[400px]">
          ...
          <h2 className="mt-3 mb-8 text-3xl text-center">STARTERS</h2>
          ...
          <p className="mb-8 text-xs">Our selection of fresh oysters, limes.</p>
          <div className="text-lg">Wild Mushroom Arancini</div>
          <p className="mb-5 text-xs">Porcini purée, parmesan, basil.</p>
        </div>
        <div className="h-[400px] ">
          <p className="mb-4 text-center text-md text-[#DD5903]">
            TOP RATED DISHES
          </p>
          <h2 className="mt-3 mb-8 text-3xl text-center">MAIN DISHES</h2>
          ...
          <p className="mb-8 text-xs">Truffle mash, pepper sauce.</p>
        ...
        <div className="h-[400px ">
          ...
          <h2 className="mt-3 mb-8 text-3xl text-center">BEVERAGE</h2>
          ...
          <p className="mb-8 text-xs">Tomato, Salt, Black Pepper, Lemon.</p>
        </div>
      </div>
      <div>
